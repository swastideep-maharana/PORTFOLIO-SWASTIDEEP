...
export const gridItems = [
  {
    ...
    titleClassName: "justify-end text-purple-600 text-sm", // Added text color and font size
  ...
  },
  {
    ...
    className: "lg:col-span-2 md:col-span-3 md:row-span-2",
    imgClassName: "",
    titleClassName: "justify-center text-sm", // Added text-sm to make the font smaller
    img: "",
    spareImg: "",
  },
  {
  ...
  {
    id: 5,
    title: "Currently building my life...",
